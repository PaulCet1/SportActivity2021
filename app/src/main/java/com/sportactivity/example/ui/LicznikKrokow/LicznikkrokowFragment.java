package com.sportactivity.example.ui.LicznikKrokow;
...
import com.sportactivity.example.AccelerationData;
import com.sportactivity.example.R;
import com.sportactivity.example.StepDetector;
import com.sportactivity.example.StepListener;
import com.sportactivity.example.StepType;
...
public class LicznikkrokowFragment extends Fragment implements SensorEventListener, StepListener {
    ...
    private LicznikkrokowViewModel mViewModel;


    public static LicznikkrokowFragment newInstance() {
        return new LicznikkrokowFragment();
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        mViewModel = new ViewModelProvider(this).get(LicznikkrokowViewModel.class);
...
/*
    ...
    private void calculateResults(){
        ...
        String averageStepFrequency = String.format(Locale.GERMANY, "%.0f", totalSteps / minutes) + " Kroki/min";
        ...
        String totalCalories = String.format(Locale.GERMANY, "%.0f", totalCaloriesBurned) + " Kalorii";
