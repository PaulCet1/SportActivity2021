...
public class AkcelerometrSensorFragment extends Fragment implements SensorEventListener {
    ...
    private AkcelerometrSensorViewModel mViewModel;

    public static AkcelerometrSensorFragment newInstance() {
        return new AkcelerometrSensorFragment();
    }
